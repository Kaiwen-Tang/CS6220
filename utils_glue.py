...
acc_tasks = ["mnli", "mrpc", "sst-2", "qqp", "qnli", "rte", "cola","news","emotion","cli"]
corr_tasks = ["sts-b"]
# mcc_tasks = ["cola"]
mcc_tasks = []
...
def compute_metrics(task_name, preds, labels):
    ...
    if task_name == "cola":
        # return {"mcc": mather_...(labels, preds)}
...
default_params = {
    ...
    "mnli":  {"num_train_epochs": 6,  "max_seq_length": 128, "batch_size": 64, "learning_rate": 2e-4 },
